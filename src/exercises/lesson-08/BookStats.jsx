...
function BookStats({ books }) {
  ...
  const calculateStats = useMemo(() => {
    ...
    const currentOldestBook = books.reduce(
      (oldest, current) =>
        current.publishYear < oldest.publishYear
          ? current
          : oldest
    ).title;
    ...
    return {
      ...
      highestRated: highestRatedBook,
      oldestBook: currentOldestBook,
    };
  }, [books]);
  ...
  //     prev.publishYear < current.publishYear
  //       ? prev
  //       : current
  //   );
  ...
  return (
    <div className={styles.statsContainer}>
      ...
      />
      <div>
        ⏱️ Calculation time: {stats.calculationTime}ms (
        {stats.microseconds}μs)
      </div>
